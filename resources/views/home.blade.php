                ...
                <div class="profile">
                    <div class="profile-navbar cursor-pointer py-2 px-3" onclick="toggleCardProfile()">
                        <div class="d-flex align-items-center gap-3">
                            <div class="profile-text">
                                ...
                                <span class="d-block text-secondary" align="right">Muhammad Afifudin</span>
                            </div>
                    ...
                    <div class="card-profile bg-white" id="cardProfile">
                        <div class="p-4">
                            ...
                            <div class="profile-text">
                                <span class="d-block fw-bold text-center fs-7">Muhammad Afifudin</span>
                                <span class="d-block text-secondary text-center fs-7">muhafifudin2306@gmail.com</span>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-3 mb-3">
                            <div class="blue-bg-primary-2 p-4 rounded">
                                ...
                                <h5 class="text-blue-dark fw-bold">150 User</h5>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-3">
                            <div class="blue-bg-primary-2 p-4 rounded">
                        ...
                        <div class="col-lg-3 mb-3">
                            <div class="blue-bg-primary-2 p-4 rounded">
                                ...
                                <h5 class="text-blue-dark fw-bold">150 Produk</h5>
                            </div>
                        </div>
                        <div class="col-lg-3 mb-3">
                            <div class="blue-bg-primary-2 p-4 rounded">
                                <h6 class="text-secondary">Jumlah Produk Aktif</h6>
                                <h5 class="text-blue-dark fw-bold">150 Produk Aktif</h5>
                            </div>
                        </div>
                    </div>
