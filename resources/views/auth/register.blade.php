        ...
        <div class="login-block d-flex align-items-center px-2 py-5 py-lg-0 px-lg-5">
            <div class="w-100 px-2 py-5 py-lg-0 px-lg-5">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <p class="text-secondary mb-5">Silahkan masukkan nama, email, nomor telepon dan password
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="exampleInputPassword1"
                                    class="form-label text-secondary font-three">Password</label>
                                <input type="password" id="password" class="form-control" name="password">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label text-secondary font-three">Confirm
                                    Password</label>
                    ...
                    <button type="submit"
                        class="btn btn-primary text-uppercase font-one l-space-2 rounded-0 px-3 py-2 blue-bg-primary blue-border-primary w-100">Submit</button>
                    <div class="py-1"></div>
                </form>
                <a href="{{ url('/') }}">
                    <button
